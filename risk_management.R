...
library(corrplot)
total = read.csv("historical_prices_total.csv")
length(unique(total$Security))
all_dates = seq.Date(from = as.Date("2022-10-17"), to = as.Date("2024-11-27"), by = "day") # creating date sequence 
